...
const EMOJI_ICON_PATTERNS: phf::Map<&str, (&str, &[u8])> = phf_map! {
    ...
    "🥵" => ("hot_face, heat",                                          include_bytes!("../../resources/emoji_icons/princess.png")),
    "🤗" => ("greeting_hands",                                          include_bytes!("../../resources/emoji_icons/princess.png")),
    "😯" => ("hushed, surprised, confused",                             include_bytes!("../../resources/emoji_icons/princess.png")),
